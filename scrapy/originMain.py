...
class Star():
    ...
    def __init__(self,name,img,birth_date,height,cup,bust,waist,hip,birth_place,hobby):
        self.name=name
        self.img=img
...
def starContentTrans(item):
        ...
        star = Star(name,img,birth_date,height,cup,bust,waist,hip,birth_place,hobby)
